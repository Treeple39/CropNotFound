...
public static class EnemyProbabilitCalculator
{
    ...
    {
        return 11 - TechLevelManager.Instance.CurrentTechLevel;
    }
    ...
    public static float CalculateChairProbability()
    {
        ...
        return  TechLevelManager.Instance.CurrentTechLevel * 0.6f;
    }
    ...
    public static float CalculateBookProbability()
    {
        ...
        return  TechLevelManager.Instance.CurrentTechLevel * 0.4f;
    }    
}
